...
public class Vimeo {
    ...
    public VimeoResponse searchVideos2(String page, String per_page, String query) throws IOException {
        return apiRequest("/videos?page=" + page + "&per_page=" + per_page + "&query=" + query+"&sort=date", HttpGet.METHOD_NAME, null, null);
    }
