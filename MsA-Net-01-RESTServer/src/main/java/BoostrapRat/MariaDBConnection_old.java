...
public class MariaDBConnection_old {
	String host;
	String dbname;
	String url;
	String password;
	...
	public MariaDBConnection_old(String host, String dbname, String username, String url, String password) {
		this.host = host;
		this.dbname = dbname;
		this.url = url;
	...
	public void createConnection () {
		try {
			...
			try {
				// TABLA JOBS
				String createJobTable = "create table job (id int not null, `user` varchar(20) NOT NULL, `path` varchar(60) NOT NULL, `params` varchar(100) NOT NULL,`assignedQueue` varchar(100) NOT NULL,`state` varchar(10) NOT NULL,`totalparts` int(3) NOT NULL,`partscompleted` int(3) NOT NULL, `initTime` bigint(20),`endTime` bigint(20),`executionTime` int(11), `storageprovider` varchar(20), `bloburl` varchar(150)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;";
			...
			try {
				// TABLA JobsTracker
				String createJobTable = "CREATE TABLE `jobTracker` (`id` int(4) NOT NULL,`service` varchar(20) NOT NULL,`job` varchar(40) NOT NULL,`part` tinyint NOT NULL, `workerName` varchar(30) NOT NULL, `workerArchitecture` varchar(10) NOT NULL,`initTime` bigint(20) NOT NULL,`endTime` bigint(20) NOT NULL,`executionTime` int(11) NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;";
				this.st.executeQuery(createJobTable);
