...
public class MariaDBConnection {
	...
	public void createStructure(){
		...
		try {
			// TABLA JOBS
			String createJobTable = "create table job (id int not null, `user` varchar(30) NOT NULL, `path` varchar(200) NOT NULL, `params` varchar(100) NOT NULL,`assignedQueue` varchar(200) NOT NULL,`state` varchar(10) NOT NULL,`totalparts` int(5) NOT NULL,`partscompleted` int(5) NOT NULL, `initTime` bigint(20),`endTime` bigint(20),`executionTime` int(11), `storageprovider` varchar(20), `bloburl` varchar(200)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;";
