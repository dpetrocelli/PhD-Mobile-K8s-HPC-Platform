...
public class Message {
	...
	public Message(String originalName, String name, int part, int qParts, String service, byte[] data, String encodingProfiles, EncodingStructure paramsEncoding, String idForAck, String cloudStorage) {
		super();
